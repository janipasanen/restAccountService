...
class BankAccountsActionBuilder @Inject()(messagesApi: MessagesApi, playBodyParsers: PlayBodyParsers)
...
/**
  ...
  */
case class PostControllerComponents @Inject()(bankAccountsActionBuilder: BankAccountsActionBuilder,
                                              bankAccountsResourceHandler: BankAccountsResourceHandler,
...
/**
  * Exposes actions and handler to the BankController by wiring the injected state into the base class.
  */
class PostBaseController @Inject()(pcc: PostControllerComponents) extends BaseController with RequestMarkerContext {
  ...
  def PostAction: BankAccountsActionBuilder = pcc.bankAccountsActionBuilder

  def bankAccountsResourceHandler: BankAccountsResourceHandler = pcc.bankAccountsResourceHandler
}
